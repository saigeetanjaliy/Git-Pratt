...
public class DiffieHellmanA{
 ...
 void generateKeyPair(){
   ...
   publicKey = alpha.modPow(privateKey,q);// what is the public key?
 ...
 void computeSharedSecret(){
    preMasterSecret = clientPublicKey.modPow(privateKey,q); // how to get the shared secret with Diffie-Hellman?
