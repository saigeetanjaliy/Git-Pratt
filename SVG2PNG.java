// SVG2PNG.java CS5125/6025 Cheng 2017
// converts SVG to PNG
...
public class SVG2PNG{
 ...
 void fillIDAT(){
   ...
   int lineOffset = 0;
   //System.out.println("height:"+height+"\twidth:"+lineWidth);
   for (int i = 0; i < height; i++){
     data[lineOffset] = 0;
